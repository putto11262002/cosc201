 ...
 */
public class StackWarehouse extends Warehouse{
    public StackWarehouse(int row, int col){
        super(row, col);
    }

    public StackWarehouse() {
        super();
    }
    ...
    public void addPacketManagers(){
        for(int r = 0; r < rows; r++){
            for(int c = 0; c < cols; c++){
                packetManagers.put(new Location(r, c), new StackManager(new Location(r, c), packetManagers));
            }
        }
    }
